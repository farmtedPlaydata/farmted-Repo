...
public class QPass extends EntityPathBase<Pass> {
    ...
    public final EnumPath<com.farmted.authservice.enums.RoleEnums> role = createEnum("role", com.farmted.authservice.enums.RoleEnums.class);

    public final StringPath socialId = createString("socialId");

    public final EnumPath<com.farmted.authservice.enums.SocialType> socialType = createEnum("socialType", com.farmted.authservice.enums.SocialType.class);
