...
public interface BoardRepository extends JpaRepository<Board, Long> {
    ...
    Page<Board> findByBoardTypeAndBoardStatus
            (BoardType boardType, boolean boardStatus, Pageable pageable);
    // 판매자 등록 전체 상품 조회
    Page<Board> findByMemberUuidBoardTypeAndBoardStatus
            (String memberUuid, BoardType boardType,
             boolean boardStatus, Pageable pageable);
    // 게시글 상세 조회
