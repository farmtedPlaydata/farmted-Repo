...
public record ProductVo (
        ...
        // 여기부터 요청할때만 필요한 값
        @JsonInclude(JsonInclude.Include.NON_NULL) @JsonProperty("boardUuid") String boardUuid,
        @JsonInclude(JsonInclude.Include.NON_NULL) @JsonProperty("productType") BoardType boardType,
